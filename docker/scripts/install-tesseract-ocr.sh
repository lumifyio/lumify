...
then
        ...
        if [ ! -f "$ARCHIVE_DIR/libpng-$LIBPNG_VERSION.tar.gz" ]; then
                #Download the file
                curl -L -o $ARCHIVE_DIR/libpng-$LIBPNG_VERSION.tar.gz http://sourceforge.net/projects/libpng/files/libpng16/older-releases/1.6.13/libpng-1.6.13.tar.gz/download
        fi
