...
function ensure_lumify_config {
  ...
  hadoop fs -put /vagrant/config/opencv/haarcascade_frontalface_alt.xml /lumify/config/opencv/
  hadoop fs -put /vagrant/config/opennlp/* /lumify/config/opennlp/
  hadoop fs -put /vagrant/config/knownEntities/dictionaries/* /lumify/config/knownEntities/dictionaries/
