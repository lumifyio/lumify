...
public class ConceptMappedColumnRelationshipMapping extends AbstractColumnRelationshipMapping {
    ...
    public ConceptMappedColumnRelationshipMapping(@JsonProperty("source") final String srcKey,
        ...
        this.labelMappings = Collections.unmodifiableList(new ArrayList<ConceptMapping>(lblMaps));

        Map<String, String> srcMap = new HashMap<String, String>();
        Map<String, String> tgtMap = new HashMap<String, String>();
        Map<String, Map<String, String>> srcTgtMap = new HashMap<String, Map<String, String>>();
        ...
        Map<String, Map<String, String>> immutableStMap = new HashMap<String, Map<String, String>>();
    ...
    protected String getLabel(final TermMention source, final TermMention target, final List<String> row) {
        ...
        if ((!sourceMap.isEmpty() || !sourceTargetMap.isEmpty()) && source != null) {
            srcConcept = ontologyRepository.getConceptByIRI(source.getOntologyClassUri());
        }
        if ((!targetMap.isEmpty() || !sourceTargetMap.isEmpty()) && target != null) {
            tgtConcept = ontologyRepository.getConceptByIRI(target.getOntologyClassUri());
        }
