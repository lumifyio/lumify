...
public abstract class AbstractMappedValueTransformerTest<T> {
    ...
    public void testIllegalConstruction() {
        ...
        doTestConstructor("empty value map, without default", Collections.EMPTY_MAP, IllegalArgumentException.class);
        doTestConstructor("null value map, with default", null, null, NullPointerException.class);
        doTestConstructor("empty value map, with default", Collections.EMPTY_MAP, null, IllegalArgumentException.class);
    }
