...
public class FallbackColumnValueTest {
    ...
    @Before
    public void setup() {
        instance = new FallbackColumnValue<Object>(primary, fallback, fallbackIf);
    }
    ...
    public void testCompareTo() {
        int comp = -42;
        when(primary.compareTo(fallback)).thenReturn(comp);
        assertEquals(comp, instance.compareTo(fallback));
    }
    ...
    private <T> void doTestConstructor(final String testName, final ColumnValue<T> primVal, final ColumnValue<T> fbVal,
        ...
        try {
            new FallbackColumnValue<T>(primVal, fbVal, pred);
    ...
    private <T> void doTestConstructor(final String testName, final ColumnValue<T> primVal, final ColumnValue<T> fbVal,
        ...
        FallbackColumnValue<T> col = new FallbackColumnValue<T>(primVal, fbVal, pred);
